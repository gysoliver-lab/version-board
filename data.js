...
const VERSION_DATA = [
    {
        version: "v1.8.x.1239",
        date: "2026-09-15",
        content: "一、新增功能：\n1.优化软件采集检测功能，采集界面新增自动单张曝光按钮\n2.优化切换低敏模式不用二次校准\n3.优化软件成像时间，增加0.05s选项\n4.增加了PDP报告中添加采集时间、曝光时间信息\n5.优化异物出现后，拿掉异物点重新校准仍会校准失败，再点重新校准能校成功\n\n二、解决bug：\n1.修复了sample图片、彩色图同时导出的bug\n2.修复了SE模组采集时不持续亮灯的问题\n3.修复了采集界面前缀修改时输入空格，字符全部消失的bug\n4.修复了EB15模组采集失败时软件卡死的BUG\n5.修复了Pro模组环影校正监测异常的问题\n6.修复了采集中途拨掉网线导致连接异常的问题",
        isLatest: true
    },
    {
        version: "v1.7.x.1230",
        date: "2026-08-13",
        content: "一、新增功能：\n1.图库界面目录结构支持方向键切换图片\n2.导出增加进度条\n3.采集页面支持双击图片跳转分析页面打开\n\n二、解决bug：\n1.采集页面张数选项、间隔选项状态不对问题\n2.采集页面偶发性采集失败还出图\n3.Pro模组灯板不亮问题\n4.极限高清每分钟出一张图，解决长时长图反而没有短时长图信号强\n5.解决偶发性断连\n6.SE模组标准版贴边放置采集竖纹\n7.偶发性auto后最后一张图片全黑，调整一下亮度对比度会自动变好\n8.导出过程中拔出U盘，软件闪退\n9.解决彩色marker偶发性图片发绿\n10.解决Pro模组环影校正监测异常",
        isLatest: false
    },
    {
        version: "v1223",
